...
/****** Object:  Job [query_stats]    Script Date: 6/6/2013 10:04:52 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]]    Script Date: 6/6/2013 10:04:52 PM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [query_stats]    Script Date: 6/6/2013 10:04:52 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'query_stats', 
		@step_id=1, 
...
BEGIN
	INSERT query_stats WITH (TABLOCK)
	SELECT (select max(query_stats.collection_id)+1 from query_stats),GETDATE(),
		[sql_handle]
      ,[plan_handle]
      ,[creation_time]
      ,[last_execution_time]
